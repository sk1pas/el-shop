...
<option value="mobile" '.$type_mobile.'>��������� ��������</option>
<option value="notebook" '.$type_notebook.'>��������</option>
<option value="notepad" '.$type_notepad.'>��������</option>
...
<h3 class="h3title" >��������� ������</h3>   
<ul id="chkbox">
<li><input type="checkbox" name="chk_visible" id="chk_visible" '.$checked1.'/><label for="chk_visible" >���������� �����</label></li>
<li><input type="checkbox" name="chk_new" id="chk_new" '.$checked2.' /><label for="chk_new" >����� �����</label></li>
<li><input type="checkbox" name="chk_leader" id="chk_leader"  '.$checked3.'/><label for="chk_leader" >���������� �����</label></li>
<li><input type="checkbox" name="chk_sale" id="chk_sale"  '.$checked4.'/><label for="chk_sale" >����� �� �������</label></li>
</ul> 


    <p align="right" ><input type="submit" id="submit_form" name="submit_save" value="���������"/></p>     
</form>
';
