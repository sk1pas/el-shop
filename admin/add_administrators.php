...
<ul id="info-admin">
<li><label>Логин</label><input type="text" name="admin_login" value="<?php echo $_POST["admin_login"];?>"/></li>
<li><label>Пароль</label><input type="password" name="admin_pass" value="<?php echo $_POST["admin_pass"];?>"/></li>
<li><label>ФИО</label><input type="text" name="admin_fio" value="<?php echo $_POST["admin_fio"];?>"/></li>
<li><label>Должность</label><input type="text" name="admin_role" value="<?php echo $_POST["admin_role"];?>"/></li>
<li><label>E-mail</label><input type="text" name="admin_email" value="<?php echo $_POST["admin_email"];?>"/></li>
<li><label>Телефон</label><input type="text" name="admin_phone" value="<?php echo $_POST["admin_phone"];?>"/></li>
</ul>
