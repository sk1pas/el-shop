...
<?php	
    ...
    if(mysql_num_rows($result1) > 0){
        ...
        do
        {
            ...
            <p id="nav-breadcrumbs"><a href="view_cat.php?type=mobile">��������� ��������</a> \ <span>'.$row1["brand"].'</span></p>
        ...
        <div>
        <p id="link-send-review"><a class="send-review" href="#send-review">�������� �����</a></p>
    ...
    <p align="right" id="title-review">���������� ������ ������������ ����� ��������������� ���������.</p>
    
    <ul>
    <li><p align="right"><label id="label-name" >���<span>*</span></label><input maxlength="15" type="text"  id="name_review" /></p></li>
    <li><p align="right"><label id="label-good" >�����������<span>*</span></label><textarea id="good_review" ></textarea></p></li>    
    <li><p align="right"><label id="label-bad" >����������<span>*</span></label><textarea id="bad_review" ></textarea></p></li>     
    <li><p align="right"><label id="label-comment" >�����������</label><textarea id="comment_review" ></textarea></p></li>     
    </ul>
